...
from multiple_linear_regression_model import MultipleLinearRegressionModel
...
grad_model = MultipleLinearRegressionModel()
...
ols_model = MultipleLinearRegressionModel()
